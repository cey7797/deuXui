	...
	<div style="width:1200px; margin:0px auto;">
		<form style="padding-left:50px; padding-top:50px;" class="form-horizontal" action="index.jsp" method="post">
			...
			<div class="control-group">
			    ...
			    <div class="controls">
			      <input type="text" class="input-xxlarge" id="url" name="jndiName" placeholder="JNDI Name" value="<%=jndiName%>">
			    </div>
			</div>
			  
			<div class="control-group">
			    <div class="controls">
			      	<button type="button" class="btn btn-primary" onclick="addJNDIDataConnection(this.form)">추가</button>
